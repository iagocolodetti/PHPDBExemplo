    ...
    <body>
        <div class="container-fluid center">
            ...
            <?php
                ...
                print("<form action=\"buscaremail.php\" method=\"POST\">");
                printf("<div class=\"row justify-content-center\">
                            <div class=\"form-group col-xs-12 col-sm-12 col-md-8 col-lg-8 text-center\">
                                ...
                                <div class=\"form-group text-center\">
                                    ...
                                    <input type=\"text\" class=\"form-control text-center\" name=\"email\" id=\"email\" value=\"%s\" required/>
                                </div>
                                <div class=\"form-group text-center\">
                ...
                if ($email != "") {
                    $cdao = new ContatoDAO();
                    $contatos = $cdao->buscarPorEmail($email);
                    ...
                    if ($contatos != null) {
                        ...
                        printf("<div class=\"alert alert-secondary\" role=\"alert\">Não existem contatos com email '%s' no banco de dados.</div>", $email);
