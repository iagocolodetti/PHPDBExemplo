    ...
    <body>
        <div class="container-fluid center">
            ...
            <?php
                ...
                print("<form action=\"buscartelefone.php\" method=\"POST\">");
                ...
                if ($telefone != "") {
                    ...
                    $contatos = $cdao->buscarPorTelefone($telefone);
                    ...
                    if ($contatos != null) {
                        ...
                        printf("<div class=\"alert alert-secondary\" role=\"alert\">Não existem contatos com telefone '%s' no banco de dados.</div>", $telefone);
